...
# If the cookie exists and is greater than 1, <code>retinaimages.php</code> checks to see if a high-res image is available. If so it will serve the high-res image; if not the standard image is served.
